...
public class editpassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        main.add(back, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 10, 80, 20));
        ...
        jPanel2.add(newpassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 130, 260, 25));
        ...
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 90, 100, 25));
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        ...
        if(newpassword.getText().isEmpty()    
         ...
         }else if(!(newpassword.getText().equals(conpassword.getText()))){
      JOptionPane.showMessageDialog(null, "password not match");
     }  else{
             
             try{
                 String pass = passwordHasher.hashPassword(newpassword.getText());
