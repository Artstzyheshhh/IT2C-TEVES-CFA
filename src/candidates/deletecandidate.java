 ...
 * @author acer
 */
public class deletecandidate extends javax.swing.JInternalFrame {
    ...
    public deletecandidate() {
       ...
       candidatestable.getTableHeader().setForeground(Color.white);
        ...
        try{
            ...
            ResultSet rs = dbc.getData("SELECT cid,lname,fname,mname,age,address,nationality,status FROM candidates");
            candidatestable.setModel(DbUtils.resultSetToTableModel(rs));
               ...
               columnModel.getColumn(3).setHeaderValue("Middlename");
               columnModel.getColumn(4).setHeaderValue("Age");
               columnModel.getColumn(5).setHeaderValue("Address");
               columnModel.getColumn(6).setHeaderValue("Nationality");
    ...
    return image;
     ...
     public boolean candidatecheck(){
        dbconnect dbc = new dbconnect();
   try {
            String query = "SELECT * FROM applications WHERE cid = '"+ idd.getText()+"'";
            ResultSet resultSet = dbc.getData(query);
            if(resultSet.next()){
                ccid= resultSet.getString("cid");
                if(ccid.equals(idd.getText())){
                JOptionPane.showMessageDialog(null,"This candidate already completed the application \n and cannot be deleted!");
                idd.setText("");
                firstname.setText("");
                lastname.setText("");
                image.setIcon(null);
